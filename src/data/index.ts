...
const sideProjects: ISideProjects[] = [
    ...
    },
    {
        ...
        img: CREASE,
        title: "dashboard",
        desc: "I was inspired to build a simple dashboard application from a design I saw online to illustrate some graphical data which is applicable to business cases.",
